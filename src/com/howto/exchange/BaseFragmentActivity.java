...
@SuppressLint("NewApi")
public abstract class BaseFragmentActivity extends SherlockFragmentActivity implements View.OnClickListener
	...
	public boolean isUpadate(String eVip) {
		...
		try {
			for (int i = 0; i < server.length; i++) {
				...
				if( Integer.parseInt(server[i]) > Integer.parseInt(local[i]))
				{
					return true;
				}
			}
